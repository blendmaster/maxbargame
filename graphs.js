...
var log, Value, Vertex, Edge, Player, DisjointSet, Strategy, State;
log = function(){};
Value = (function(){
...
Edge = (function(superclass){
  ...
  function Edge(id, $0, $1, bandwidth){
    this.id = id;
    this[0] = $0;
    this[1] = $1;
  ...
  do {
    ...
    for (i$ = 0, len$ = players.length; i$ < len$; ++i$) {
      ...
      if (br.bandwidth > strategy.bandwidth) {
        ...
        next = allocate(topology, nextPaths, player);
        log(next);
      } else {
        log("no better...");
      }
