...
var width, height, vertices, edges, topology, players, pathIdx, playerColor, paths, i$, len$, i, p, ref$, game, x$, strokeScale, y$, forceEnabled, force, idx, state, users, allocLine, selected, z$, svg, transition, fadeOut, identity, dragEdge, draw;
width = 800;
height = 500;
...
ref$ = randomTopology(10, 20), vertices = ref$.vertices, edges = ref$.edges, players = ref$.players, paths = ref$.paths;
topology = {
  vertices: vertices,
  edges: edges
};
...
y$ = document.getElementById('force-enabled');
forceEnabled = y$.checked;
