...
var width, height, vertices, edges, topology, players, pathIdx, playerColor, paths, i$, len$, i, p, game, strokeScale, force, idx, state, users, player, ref$, strategy, ref1$, edge, allocLine, draw;
width = 500;
height = 500;
...
draw = function(){
  ...
  y$.exit().remove();
  y$.enter().append('circle').attr('class', 'vertex').call(force.drag).on('mouseenter', function(it){
    var that;
